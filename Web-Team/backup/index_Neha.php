...
<body>
    ...
    <div class="page">
                        ...
                        <div class="rd-navbar-nav-wrap"><a href="index.html">
                            ...
                            <ul class="rd-navbar-nav ">
                                <li class="rd-nav-item active">
                                    ...
                                    <a class="rd-nav-link" href="mibaio_main" id="home-tab">
                ...
                <div class="box-custom-4-main">
                    <div class="block-10">
                        ...
                        <h1 class="extra-light text-white heading-decoration-3 wow fadeInUp" data-wow-delay=".4s">
                            <span class="typed-text text-primary" data-strings="[&quot;phone&quot;, &quot;home&quot;, &quot; electrical appliances&quot;, &quot;lifestyle&quot;, &quot;smartphone&quot;, &quot;fingers&quot;]" data-type-speed="100">home</span>
            ...
            <div class="container">
                ...
                <div class="row">
                    <div class="col-md-6 col-lg-3" data-aos="fade-up">
                        <div class="icon-box">
                            <div class="icon white-icon"><a href="#Security">
                            ...
                            <div class="icon blue-icon"><a href="#Security">
                                    <script src="https://cdn.lordicon.com/libs/mssddfmo/lord-icon-2.1.0.js"></script>
                                    <lord-icon src="https://cdn.lordicon.com/rqqkvjqf.json" trigger="loop" colors="primary:#3080e8,secondary:#3080e8" style="width:50px;height:50px">
                                    </lord-icon>
                                </a>
                            </div>
                        ...
                        <!-- <div class="icon-box">
                            <div class="icon blue-icon"><a href="#Security">
                                    <script src="https://cdn.lordicon.com/libs/mssddfmo/lord-icon-2.1.0.js"></script>
                                    <lord-icon src="https://cdn.lordicon.com/rqqkvjqf.json" trigger="loop"
                                        colors="primary:#3080e8,secondary:#3080e8" style="width:50px;height:50px">
                                    </lord-icon>
                                </a>
                            </div>
                            <h4 class="title"><a href="#Security">Security</a></h4>
                    ...
                    <div class="col-md-6 col-lg-3" data-aos="fade-up" data-aos-delay="100">
                        <div class="icon-box">
                            <div class="icon white-icon"><a href="#Voice">
                                    <script src="https://cdn.lordicon.com/libs/mssddfmo/lord-icon-2.1.0.js"></script>
                            ...
                            <div class="icon blue-icon"><a href="#Voice">
                                    <script src="https://cdn.lordicon.com/libs/mssddfmo/lord-icon-2.1.0.js"></script>
                                    <lord-icon src="https://cdn.lordicon.com/fpipqhrr.json" trigger="loop" colors="primary:#4e83f1,secondary:#3080e8" style="width:50px;height:50px">
                                    </lord-icon>
                                </a>
                            </div>
                    ...
                    <div class="col-md-6 col-lg-3" data-aos="fade-up" data-aos-delay="200">
                        <div class="icon-box">
                            <div class="icon white-icon"><a href="#MMC">
                                    <script src="https://cdn.lordicon.com/libs/mssddfmo/lord-icon-2.1.0.js"></script>
                                    <lord-icon src="https://cdn.lordicon.com/efzyjota.json" trigger="loop" colors="primary:#ffffff,secondary:#ffffff" style="width:50px;height:50px">
                                    </lord-icon>
                                </a>
                            </div>
                            <div class="icon blue-icon"><a href="#MMC">
                                    <script src="https://cdn.lordicon.com/libs/mssddfmo/lord-icon-2.1.0.js"></script>
                                    <lord-icon src="https://cdn.lordicon.com/efzyjota.json" trigger="loop" colors="primary:#3080e8,secondary:#3080e8" style="width:50px;height:50px">
                                    </lord-icon>
                                </a>
                            </div>
                    ...
                    <div class="col-md-6 col-lg-3" data-aos="fade-up" data-aos-delay="300">
                        <div class="icon-box">
                            <div class="icon white-icon"><a href="#Surge">
                                    <script src="https://cdn.lordicon.com/libs/mssddfmo/lord-icon-2.1.0.js"></script>
                            ...
                            <div class="icon blue-icon"><a href="#Surge">
                                    <script src="https://cdn.lordicon.com/libs/mssddfmo/lord-icon-2.1.0.js"></script>
                                    <lord-icon src="https://cdn.lordicon.com/sbiheqdr.json" trigger="loop" colors="primary:#3080e8,secondary:#08a88a" style="width:50px;height:50px">
                                    </lord-icon>
                    ...
                    <div class="col-md-4 col-lg-5 wow fadeInLeftSmall left-pattern">
                        ...
                        <div class="slick-slider slick-slider-phone-frame-2 slick-style-1" data-focus-behaviour="true" data-arrows="true" data-loop="false" data-dots="false" data-swipe="false" data-speed="700" data-initial-slide="1" data-items="2" data-sm-items="2" data-md-items="2" data-lg-items="2" data-xl-items="2" data-xxl-items="2">
                            <!-- <div class="item">
                                ...
                                <div class="phone-frame-2 feature_img"><img class="phone-frame-2-outer"
                                        src="images/iphonex-mockup-1-261x520.png" alt="" width="261" height="520" />
                                    <div class="phone-frame-2-inner" style="background-color:#0accbe;">

                                        <img class="image-MMC" src="images/MMC.png" style="padding-top: 200px;" />
                                    </div>
        ...
        <section id="services-1" class="services-1 section section-md bg-gray-3 text-center">
            <div class="container">
                <div class="container"><span class="normal text-primary font-weight-bold text-uppercase wow fadeIn">Our
                        Website</span>
                ...
                <div class="row">
                    <div class="col-md-6 col-lg-3 d-flex align-items-stretch mb-5 mb-lg-0">
                        <div class="icon-box wow fadeInRight" data-wow-delay=".4s">
                            ...
                            <p class="description">Select the model that suits your needs from our collection of best
                                price models</p>
                        </div>
                    </div>
                    ...
                    <div class="col-md-6 col-lg-3 d-flex align-items-stretch mb-5 mb-lg-0">
                        <div class="icon-box wow fadeInLeft" data-wow-delay=".85s">
                            ...
                            <p class="description"><strong>Login</strong> and go to your Home's dashboard to start
                                experiencing the feel of a truly smart home</p>
                        </div>
                    </div>
            ...
            <div class="container">
                ...
                <div class="row">
                    <div class="col-12 text-center">
                        <span class="normal text-primary font-weight-bold text-uppercase wow fadeIn">Our Website</span>
                        <h3 class="offset-top-7 font-weight-regular wow fadeIn">How It Works</h3>
                    </div>
                    <div class="col-12 text-right">
                        <a class="btn btn-primary-1 mb-3 mr-1" href="#carouselExampleIndicators2" role="button" data-slide="prev">
                            <i class="bi bi-arrow-left-circle"></i>
                        </a>
                        <a class="btn btn-primary-1 mb-3 " href="#carouselExampleIndicators2" role="button" data-slide="next">
                                    ...
                                    <div class="row">
                                        <div class="col-md-4 mb-2">
                                            <div class="card_steps">
                                                <div class="text-center steps_img">
                                                    <img class="img-fluid" src="images/steps/visit.svg" alt="">
                                                </div>
                                                
                                                <div class="card-body">
                                                    <h4 class="card-title">Visit Our Page</h4>
                                        ...
                                        <div class="col-md-4 mb-2">
                                            <div class="card_steps">
                                                ...
                                                <div class="card-body">
                                                    <h4 class="card-title">Select a model</h4>
                                                    <p class="card-text">With supporting text below as a natural
                                                        lead-in to additional content.</p>
                                        ...
                                        <div class="col-md-4 mb-2">
                                            <div class="card_steps">
                                                <div class="text-center steps_img">
                                                    <img class="img-fluid" src="images/steps/password.svg" alt="">
                                                </div>
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-4 mb-2">
                                            <div class="card_steps">
                                                ...
                                                <div class="card-body">
                                                    <h4 class="card-title">Add the model in Cart</h4>
                                                    <p class="card-text">With supporting text below as a natural
                                                        lead-in to additional content.</p>
                                        ...
                                        <div class="col-md-4 mb-2">
                                            <div class="card_steps">
                                                <div class="text-center steps_img">
                                                    <img class="img-fluid" src="images/steps/buy.svg" alt="">
                                                </div>
                                                
                                                <div class="card-body">
                                                    <h4 class="card-title">Buy the Model</h4>
                                                    <p class="card-text">With supporting text below as a natural
                                                        lead-in to additional content.</p>
                                        ...
                                        <div class="col-md-4 mb-2">
                                            <div class="card_steps">
                                                <div class="text-center steps_img">
                                                    <img class="img-fluid" src="images/steps/home.svg" alt="">
                                                </div>
                                                
                                                <div class="card-body">
                                                    <h4 class="card-title">Go to Dashboard</h4>
                                                    <p class="card-text">With supporting text below as a natural
                                                        lead-in to additional content.</p>
                                                </div>
            ...
            <!-- <div class="container">
                <div class="row row-50 justify-content-xl-between align-items-center">
                    <div class="col-md-8 col-lg-7 col-xl-6 wow fadeInLeftSmall">
                        ...
                        <div class="block-4 offset-top-4">
                            <p class="big">Design your mobile application according to your choice of colors. Improve
                                your lifestyle
                    ...
                    <div class="col-md-4 col-lg-5 wow fadeInRightSmall right-pattern">
                        ...
                        <div class="slick-slider slick-slider-phone-frame-2 slick-style-1" data-focus-behaviour="true"
                            data-arrows="true" data-loop="false" data-dots="false" data-swipe="false" data-speed="700"
                            data-initial-slide="1" data-items="2" data-sm-items="2" data-md-items="2" data-lg-items="2"
                            ...
                            <div class="item">
                                <div class="phone-frame-2"><img class="phone-frame-2-outer"
                                        src="images/iphonex-mockup-1-261x520.png" alt="" width="261" height="520" />
                                    <div class="phone-frame-2-inner"
                                        style="background-image: url(images/phone-image-2-227x492.jpg);">
                                    </div>
                                </div>
                            </div>
                        </div>
            ...
            <!-- <div class="container">
                <div class="row row-50 justify-content-xl-between align-items-center flex-md-row-reverse">
                    <div class="col-md-8 col-lg-7 col-xl-6 wow fadeInRightSmall">
                        ...
                        <div class="block-4 offset-top-4">
                            <p class="big">With inspiration from "आत्मनिर्भर भारत अभियान", we are comitted to provide
                                our customers a
                            ...
                            <div class="group-buttons-responsive group-middle"><a
                                    class="button button-secondary button-winona" href="services.html">View All
                                    Features</a><a class="button button-default-outline button-winona"
                                    style="color:#0accbe" href="about-us.html">Learn More</a></div>
                        </div>
                    </div>
                    <div class="col-md-4 col-lg-5 wow fadeInLeftSmall left-pattern">
                        ...
                        <div class="slick-slider slick-slider-phone-frame-2 slick-style-1" data-focus-behaviour="true"
                            data-arrows="true" data-loop="false" data-dots="false" data-swipe="false" data-speed="700"
                            data-initial-slide="0" data-items="2" data-sm-items="2" data-md-items="2" data-lg-items="2"
                            data-xl-items="2" data-xxl-items="2">
                            <div class="item">
                                <div class="phone-frame-2"><img class="phone-frame-2-outer"
                                        src="images/iphonex-mockup-1-261x520.png" alt="" width="261" height="520" />
                                    <div class="phone-frame-2-inner"
                                        style="background-image: url(images/phone-image-3-227x492.jpg);">
                                    </div>
                                    <div class="tooltip-point" data-toggle="tooltip" data-placement="top"
                                        data-class="tooltip-light" title="Perfect smarthome solution"
                                        style="position: absolute; top: 47%; left: 35.9%;"></div>
                                </div>
                            </div>
                            <div class="item">
                                <div class="phone-frame-2"><img class="phone-frame-2-outer"
        ...
        <!-- Popular Questions-->
        <section class="section section-md bg-gray-100 text-center wow fadeInUp" data-wow-delay=".3s">
