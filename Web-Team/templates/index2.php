...
<body>
    ...
    <div class="page">
                ...
                <div class="box-custom-4-main">
                    <div class="block-10">
                        ...
                        <div class="group wow clipInLeft wow fadeInUp" data-wow-delay="1.3s"><a class="button button-default-outline button-winona" href="#" data-wow-duration=".5s" data-wow-delay=".5s">
                            ...
                            </a><a class="button button-icon button-icon-right button-secondary button-winona wow clipInLeft wow fadeInUp" data-wow-delay="1.3s" href="model_copy.php" data-wow-duration=".5s">Buy Now</a></div>
                    </div>
                </div>
        ...
        <section class="my-5">
            <h2 class="h11-responsive font-weight-regular text-center my-5">How does MIBAiO benefit you?</h2>
            <!-- Section description -->
            <!-- Grid row 1-->
            <div class="container" id="Security">
                <div class="row row-50 justify-content-xl-between align-items-center flex-md-row-reverse">
                    <div class=" col-1 col-md-81 col-lg-7 col-xl-6 wow fadeInRightSmall" style="visibility: visible; animation-name: fadeInRightSmall;">
                        <div class="unit unit-spacing-1 align-items-center">
                            <div class="unit-body">
                                <h3><span><strike> Replace</strike></span><span class="typed-text text-primary" data-strings="[&quot;Upgrade!&quot;, &quot;Automate!&quot;]" data-type-speed="100"></span></h3>
                            </div>
                        </div>
                        <div class="block-4 offset-top-4">
                            ...
                            <blockquote class="quote-light">
                                <div class="quote-light-text">
                                    <ul class="list-marked list-marked_secondary1">
                                        <li>MIBAIO helps you upgrade to the latest Smart technology without changing the
                                            existing appliances.</li>
                                        <li>Revolutionize your home by trusting our device which gives you access to your
                                            entire house.</li>
                                    </ul>
                                </div>
                            </blockquote>
                    ...
                    <div class="col-11 col-md-41 col-lg-5 wow fadeInLeftSmall " style="visibility: visible; animation-name: fadeInLeftSmall;">
                        <!-- animation 1-->
                        <div class="lottie-container">
                            <script src="https://unpkg.com/@lottiefiles/lottie-player@latest/dist/lottie-player.js"></script>
                            <lottie-player src="https://assets9.lottiefiles.com/packages/lf20_mboj5x.json" background="#4A80F0" speed="1.5" loop autoplay>
                                </lottie-player1>
                        </div>
                    </div>
                </div>
            ...
            <div class="container" id="Surge">
                <div class="row row-50 justify-content-xl-between align-items-center">
                    <div class="col-md-82 col-lg-7 col-xl-6 wow fadeInLeftSmall">
                        <div class="unit unit-spacing-1 align-items-center">
                            <div class="unit-body" style="font: size 37px;">
                                <h3>To Tired TO Switch Off The Lights?</h3>
                            </div>
                        </div>
                        <div class="block-4 offset-top-4">
                            <p class="big"></p>
                            ...
                            <blockquote class="quote-light">
                                <div class="quote-light-text">
                                    <div class="quote-light-text">
                                        <ul class="list-marked list-marked_secondary1">
                                            <li>Too tired to get up and switch off the lights that are all the way across
                                                the room?
                                                Don't worry! MIBIAO lets you complete the task with a simple tap on your
                                                screen.</li>
                                            <li>By giving you complete assurance of the security at your place,our team
                                                wants to deliver a comforting and luxurious life.</li>
                                        </ul>
                                    </div>
                    ...
                    <div class="col-md-4 col-lg-5 wow fadeInRightSmall ">
                        <!-- animation3-->
                        <div class="lottie-container2">
                            <script src="https://unpkg.com/@lottiefiles/lottie-player@latest/dist/lottie-player.js"></script>
                            <lottie-player src="https://assets3.lottiefiles.com/packages/lf20_z4uccqir.json" background="#4A80F0" speed="1.5" loop autoplay>
                            </lottie-player>
                        </div>
                    </div>
                </div>
            ...
            <div class="container" id="Security">
                <div class="row row-50 justify-content-xl-between align-items-center flex-md-row-reverse">
                    <div class=" col-1 col-md-81 col-lg-7 col-xl-6 wow fadeInRightSmall" style="visibility: visible; animation-name: fadeInRightSmall;">
                        ...
                        <div class="block-4 offset-top-4">
                            ...
                            <blockquote class="quote-light">
                                <div class="quote-light-text">
                                    <ul class="list-marked list-marked_secondary1">
                                        <li>MIBAIO helps you upgrade to the latest Smart technology without changing the existing appliances.</li>
                                        <li>Revolutionize your home by trusting our device which gives you access to your entire house.</li>
                                    </ul>
                                    </ul>
                                </div>
                            </blockquote>
                    ...
                    <div class="col-11 col-md-41 col-lg-5 wow fadeInLeftSmall " style="visibility: visible; animation-name: fadeInLeftSmall;">
                        ...
                        <div class="lottie-container">
                            <script src="https://unpkg.com/@lottiefiles/lottie-player@latest/dist/lottie-player.js"></script>
                            <lottie-player src="https://assets8.lottiefiles.com/packages/lf20_6s2xGI.json" background="#4A80F0" speed="1.5" loop autoplay></lottie-player>
                        </div>
                        ...
                        <div class="slick-slider slick-slider-phone-frame-2 slick-style-1" data-focus-behaviour="true" data-arrows="true" data-loop="false" data-dots="false" data-swipe="false" data-speed="700" data-initial-slide="0" data-items="2" data-sm-items="2" data-md-items="2" data-lg-items="2" data-xl-items="2" data-xxl-items="2">
                            <div class="item">
                                <div class="phone-frame-2"><img class="phone-frame-2-outer" src="images/iphonex-mockup-1-261x520.png" alt="" width="261" height="520" />
                                    <div class="phone-frame-2-inner" style="background-image: url(images/SecuritySectioniphone-frame-3-inner-5-300x650.png);">
                                    </div>
                            ...
                            <div class="item">
                                <div class="phone-frame-2"><img class="phone-frame-2-outer" src="images/iphonex-mockup-1-261x520.png" alt="" width="261" height="520" />
                                    <div class="phone-frame-2-inner" style="background-image: url(images/SecuritySectioniphone-frame-3-inner-6-300x650.png);"></div>
                                </div>
                            </div>
                        </div>
                    </div>
                ...
                <div class="row row-50 justify-content-xl-between align-items-center">
                    ...
                    <div class="col-md-4 col-lg-5 wow fadeInRightSmall right-pattern" id="Voice">
                        ...
                        <div class="slick-slider slick-slider-phone-frame-2 slick-style-1" data-focus-behaviour="true" data-arrows="true" data-loop="false" data-dots="false" data-swipe="false" data-speed="700" data-initial-slide="1" data-items="2" data-sm-items="2" data-md-items="2" data-lg-items="2" data-xl-items="2" data-xxl-items="2">
                            <div class="item">
                                <div class="phone-frame-2"><img class="phone-frame-2-outer" src="images/iphonex-mockup-1-261x520.png" alt="" width="261" height="520" />
                                    <div class="phone-frame-2-inner" style="background-image: url(images/VoiceControliphone-frame-3-inner-8-300x650.png);"></div>
                                </div>
                            </div>
                            <div class="item">
                                <div class="phone-frame-2 feature"><img class="phone-frame-2-outer" src="images/iphonex-mockup-1-261x520.png" alt="" width="261" height="520" />
                                    <div class="phone-frame-2-inner" style="background-image: url(images/iphone-frame-3-inner-1-300x650.png);">
                                        <video id="myvideo" src="images/Voice.mp4" loop muted autoplay playsinline></video>
                                    </div>
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="col-md-4 col-lg-5 wow fadeInLeftSmall left-pattern">
                        ...
                        <div class="slick-slider slick-slider-phone-frame-2 slick-style-1" data-focus-behaviour="true" data-arrows="true" data-loop="false" data-dots="false" data-swipe="false" data-speed="700" data-initial-slide="1" data-items="2" data-sm-items="2" data-md-items="2" data-lg-items="2" data-xl-items="2" data-xxl-items="2">
                            <div class="item">
                                ...
                                <div class="phone-frame-2 feature_img"><img class="phone-frame-2-outer" src="images/iphonex-mockup-1-261x520.png" alt="" width="261" height="520" />
                            ...
                            <div class="item">
                                <div class="phone-frame-2 feature"><img class="phone-frame-2-outer" src="images/iphonex-mockup-1-261x520.png" alt="" width="261" height="520" />
                                    <div class="phone-frame-2-inner" style="background-image: url(images/iphone-frame-3-inner-1-300x650.png);">
                                        <video id="myvideo" src="images/MultiModeSectionPhoneScreenVideo.mp4" loop muted autoplay playsinline></video>
                                    </div>
                                </div>
                            </div>
                        </div>
                ...
                <div class="row row-50 justify-content-xl-between align-items-center">
                    ...
                    <div class="col-md-4 col-lg-5 wow fadeInRightSmall right-pattern">
                        ...
                        <div class="slick-slider slick-slider-phone-frame-2 slick-style-1" data-focus-behaviour="true" data-arrows="true" data-loop="false" data-dots="false" data-swipe="false" data-speed="700" data-initial-slide="1" data-items="2" data-sm-items="2" data-md-items="2" data-lg-items="2" data-xl-items="2" data-xxl-items="2">
                            <div class="item">
                                <div class="phone-frame-2"><img class="phone-frame-2-outer" src="images/iphonex-mockup-1-261x520.png" alt="" width="261" height="520" />
                                    <div class="phone-frame-2-inner" style="background-image:url(images/iphone-frame-3-inner-1-300x650.png);"></div>
                                </div>
                            </div>
                            <div class="item">
                                <div class="phone-frame-2 feature"><img class="phone-frame-2-outer" src="images/iphonex-mockup-1-261x520.png" alt="" width="261" height="520" />
                                    <div class="phone-frame-2-inner">
                                        <video id="myvideo" src="images/SurgeProofiPhonemockup(2).mp4" loop muted autoplay playsinline></video>
                                    </div>
                                </div>
                            </div>
                        </div>
                ...
                <div class="row row-50 justify-content-xl-between align-items-center">
                    ...
                    <div class="col-md-4 col-lg-5 wow fadeInRightSmall right-pattern">
                        ...
                        <div class="slick-slider slick-slider-phone-frame-2 slick-style-1" data-focus-behaviour="true" data-arrows="true" data-loop="false" data-dots="false" data-swipe="false" data-speed="700" data-initial-slide="1" data-items="2" data-sm-items="2" data-md-items="2" data-lg-items="2" data-xl-items="2" data-xxl-items="2">
                            ...
                            <div class="item">
                                <div class="phone-frame-2"><img class="phone-frame-2-outer" src="images/iphonex-mockup-1-261x520.png" alt="" width="261" height="520" />
                                    <div class="phone-frame-2-inner" style="background-image: url(images/phone-image-2-227x492.jpg);">
                                    </div>
                                </div>
                            </div>
                        </div>
                ...
                <div class="row row-50 justify-content-xl-between align-items-center flex-md-row-reverse">
                    <div class="col-md-8 col-lg-7 col-xl-6 wow fadeInRightSmall">
                        ...
                        <div class="block-4 offset-top-4">
                            ...
                            <div class="group-buttons-responsive group-middle"><a class="button button-secondary button-winona" href="services.html">View All
