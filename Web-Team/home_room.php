...
<head>
    ...
    <style>
        h2.h1-responsive.font-weight-bold.text-center.my-5 {
            padding-top: 18px;
        }

        h3.offset-top-7.font-weight-regular.wow.fadeIn {
            text-align: center;
            color: #0accbe;
        }
...
<body>
    ...
    <div class="page">
        ...
        <form action="/action_page.php">
            ...
            <input type="text" id="fname" name="fname" value="Home"><br>
            <input type="submit" value="Submit">
            <input type="reset">
        </form>

        <div class="environment font-weight-bold text-center my-4">HOME</div>
        ...
        <form action="/action_page.php">
            ...
            <input type="text" id="fname" name="fname" value="Bedroom"><br>
            <input type="submit" value="Submit">
            <input type="reset">
        </form>
